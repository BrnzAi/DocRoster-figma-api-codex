...
class UploadFacade {
  constructor() {
    ...
    this.progressSignal = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(0, ...(ngDevMode ? [{
      debugName: "progressSignal"
    }] : []));
    this.uploadingSignal = (0,_angular_core__WEBPACK_IMPORTED_MODULE_0__.signal)(false, ...(ngDevMode ? [{
      debugName: "uploadingSignal"
    }] : []));
    this.progress = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.computed)(() => this.progressSignal(), ...(ngDevMode ? [{
      debugName: "progress"
    }] : []));
    this.isUploading = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.computed)(() => this.uploadingSignal(), ...(ngDevMode ? [{
      debugName: "isUploading"
    }] : []));
  }
  upload(request) {
    ...
    return this.http.mutate(() => {
      ...
      return result;
    }, 450).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(() => this.progressSignal.set(100)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.finalize)(() => this.uploadingSignal.set(false)));
  }
  reset() {
    this.progressSignal.set(0);
    this.uploadingSignal.set(false);
  }
  static #_ = _staticBlock = () => (this.ɵfac = function UploadFacade_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || UploadFacade)();
...
/* harmony import */ var _data_access_upload_facade__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../data-access/upload.facade */ 1768);
...
function UploadPageComponent_div_21_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate1"]("Progress: ", ctx_r0.progress(), "%");
  }
}
function UploadPageComponent_p_22_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate"](ctx_r0.result());
  }
}
...
class UploadPageComponent {
  constructor() {
    ...
    this.facade = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.inject)(_data_access_upload_facade__WEBPACK_IMPORTED_MODULE_4__.UploadFacade);
    this.form = this.fb.nonNullable.group({
      ...
      summary: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.minLength(12)]],
    ...
    this.result = (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__.signal)(null, ...(ngDevMode ? [{
      debugName: "result"
    }] : []));
  }
  submit() {
  ...
  static #_ = _staticBlock = () => (this.ɵfac = function UploadPageComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || UploadPageComponent)();
    ...
    template: function UploadPageComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelement"](2, "dr-section-header", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](3, "form", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("ngSubmit", function UploadPageComponent_Template_form_ngSubmit_3_listener() {
          return ctx.submit();
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](8, " Organization ");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](14, " Summary ");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelement"](15, "textarea", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](16, "label");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](17, " File name (mock) ");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelement"](18, "input", 8);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementStart"](19, "button", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtext"](20);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtemplate"](21, UploadPageComponent_div_21_Template, 3, 1, "div", 10)(22, UploadPageComponent_p_22_Template, 2, 1, "p", 11)(23, UploadPageComponent_p_23_Template, 2, 1, "p", 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵelementEnd"]()()();
      }
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("disabled", ctx.isUploading());
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵtextInterpolate1"](" ", ctx.isUploading() ? "Uploading\u2026" : "Submit for review", " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngIf", ctx.isUploading());
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngIf", ctx.status() === "complete");
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵadvance"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("ngIf", ctx.status() === "error");
      }
    },
    dependencies: [_angular_forms__WEBPACK_IMPORTED_MODULE_2__.ReactiveFormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ɵNgNoValidate"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.NgControlStatusGroup, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormGroupDirective, _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControlName, _angular_common__WEBPACK_IMPORTED_MODULE_0__.NgIf, _shared_ui_section_header_section_header_component__WEBPACK_IMPORTED_MODULE_3__.SectionHeaderComponent],
    styles: [".upload[_ngcontent-%COMP%] {\n  background: #eef1ff;\n}\n.upload__form[_ngcontent-%COMP%] {\n  display: grid;\n  gap: 1rem;\n  max-width: 640px;\n  margin: 0 auto;\n}\n.upload__form[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  display: grid;\n  gap: 0.35rem;\n  font-weight: 600;\n}\n.upload__form[_ngcontent-%COMP%]   label[_ngcontent-%COMP%]   input[_ngcontent-%COMP%], \n.upload__form[_ngcontent-%COMP%]   label[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%] {\n  padding: 0.85rem 1rem;\n  border-radius: 12px;\n  border: 1px solid rgba(213, 220, 240, 0.9);\n  font-size: 1rem;\n}\n.upload__form[_ngcontent-%COMP%]   label[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%] {\n  resize: vertical;\n}\n.upload__progress[_ngcontent-%COMP%] {\n  background: #ffffff;\n  border-radius: 12px;\n  padding: 0.75rem 1rem;\n  color: #3d7aff;\n}\n.upload__message[_ngcontent-%COMP%] {\n  color: #21b128;\n}\n.upload__error[_ngcontent-%COMP%] {\n  color: #ff3d00;\n}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
    changeDetection: 0
  }));
}
_staticBlock();
